...
public class UserManagementRoleTest extends BasicInitialization{
	...
	public void tc_001_verifyAddRoleFormElements() {
		umr= new UM_RolesPageLocators(driver);
	...
	public void tc_002_verifyAddNewRole(HashMap<String, String> input) {
		umr= new UM_RolesPageLocators(driver);
		 umr.addNewRole(input.get("rolename"));
				//, input.get("productname"));
	//	Assert.assertEquals(str.get("confirmmsg"), "New Role Created " +"'"+ input.get("rolename")+ "' for " + str.get("pname"), 
